-- Baseline seed data (devices, clients, targets, alarm_rules).
-- Moved from supabase/seed.sql so that `supabase db push` applies it to cloud.
-- All inserts are idempotent (on conflict ... do nothing/update).
